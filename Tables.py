class Tables:
    ...
    # i = version - 1
    # j = EC Level {"L": 0, "M" :1, "Q": 2, "H": 3}
    # k = Total Data Codewords, EC Codewords per block, Blocks in group 1, Data Codewords per block in group1, Blocks in group 2, Data Codewords per block in group 2
